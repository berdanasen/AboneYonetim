...
{
    [Area("Admin")]
    public class DonemController : BaseController
    {
        public DonemController(IHttpContextAccessor cnt, IConfiguration configuration) : base(cnt, configuration)
        {
